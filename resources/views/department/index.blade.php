    ...
    <div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bold m-0 fs-3">Department</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-500">Department</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#departmentModal" id="addNew" name="addNew">
                                <i class="ki-duotone ki-plus fs-2"></i>Add Department</button>
                            <!--end::Add user-->
                        </div>
                        <div class="modal fade" tabindex="-1" id="departmentModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Form Department</h3>
                                    ...
                                    <form method="post" id="departmentForm" name="departmentForm">
                                        @csrf
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#saveBtn').click(function(e) {
                e.preventDefault();
                var isValid = $("#departmentForm").valid();
                if (isValid) {
                    $('#saveBtn').text('Save...');
            ...
            $('#departmentTable').on("click", ".btnEdit", function() {
                $('#departmentModal').modal('show');
                isUpdate = true;
                var id = $(this).attr('data-id');
                var url = "{{ route('department/show', ['id' => ':id']) }}";
            ...
            $('#departmentTable').on("click", ".btnDelete", function() {
                ...
                swalWithBootstrapButtons.fire({
                    title: 'Confirmation',
                    text: "You will delete this department. Are you sure you want to continue?",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        var url = "{{ route('department/delete', ['id' => ':id']) }}";
                        url = url.replace(':id', id);
                        $.ajax({
                            headers: {
