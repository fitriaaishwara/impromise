                    ...
                    <div class="mb-5 hover-scroll-x">
                        <div class="d-grid">
                            <ul class="nav nav-tabs flex-nowrap text-nowrap">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active" href="{{ url('finding/'.$internalAudit->id) }}">Finding</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
                            ...
                            <div class="card">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" id="search" name="search"
                                                class="form-control form-control-solid w-250px ps-13" placeholder="Search Finding" />
                                        </div>
                                        <!--end::Search-->
                                    </div>
                                    <!--begin::Card title-->
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        {{-- <div class="d-flex justify-content-end">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#findingModal" id="addNew" name="addNew">
                                                <i class="ki-duotone ki-plus fs-2"></i>Create</button>
                                            <!--end::Add user-->
                                        </div> --}}
                                        <div class="modal fade" tabindex="-1" id="findingModal">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title">Form Action Finding</h3>
                                                    ...
                                                    <form method="post" id="findingForm" name="findingForm">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input id="internal_audit_instrument_id" type="hidden" class="form-control" name="internal_audit_instrument_id" value="{{ $internalAuditInstruments->id }}">
                                                            <div class="form-group row mb-3">
                                                                <label for="analysis validate" class="col-md-4 form-label required">Cause Analysis</label>
                                                                <div class="col-md-8 validate">
                                                                    <textarea id="analysis" rows="3" name="analysis" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-3">
                                                                <label for="correction" class="col-md-4 form-label required">Correction</label>
                                                                <div class="col-md-8 validate">
                                                                    <textarea id="correction" rows="3" name="correction" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-3">
                                                                <label for="corrective" class="col-md-4 form-label required">Corrective Action</label>
                                                                <div class="col-md-8 validate">
                                                                    <textarea id="corrective" rows="3" name="corrective" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-3">
                                                                <label for="document" class="col-md-4 form-label required">Document</label>
                                                                <div class="col-md-8 validate">
                                ...
                                <div class="card-body py-4">
                                    <!--begin::Table-->
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="findingTable">
                                        <thead>
...
<script type="text/javascript">
    $(function() {
        ...
        var dTable = $('#findingTable').DataTable({
            ajax: {
                url: "{{ url ('finding/dt/' . $internalAudit->id) }}",
                headers: {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (data == 1) {
                            ...
                            return '<span class="badge badge-light-warning">NC Minor</span>';
                        } else if (data == 4) {
                            return '<span class="badge badge-light-primary">NC OFI</span>';
                        }
                    }
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (data == 1) {
                            ...
                            return '<span class="badge badge-light-primary">Close</span>';
                        }
                    }
                },
                {
        ...
        $('#findingTable').on("click", ".btnEdit", function() {
            $('#findingModal').modal('show');
            isUpdate = true;
            var id = $(this).attr('data-id');
            var url = "{{ route('finding/show', ['id' => ':id']) }}";
        ...
        $('#findingForm').validate({
            rules: {
                internal_audit_instrument_id: {
                    required: true,
                },
                analysis: {
                    required: true,
